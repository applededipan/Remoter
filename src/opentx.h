...
//#define LIB_ERASE_FLASH_ALL

//! define autopilot type
//#define LIB_AUTOPILOT_TYPE
...
//! define whether printf debug message
//#define APPLE_DEBUG

//! define whether control gimbal
...
//! define throw control
//#define THROW_CONTROL

//! define 18650 battery type
#define BAT18650 //! if defined BAT18650, means use the 18650, else means use the normal lithium battery
...
#if defined (FRSKY)      // FrSky Telemetry
  #include "telemetry/frsky.h"
#elif defined(JETI)      // Jeti-DUPLEX Telemetry
  #include "telemetry/jeti.h"
#elif defined(ARDUPILOT) // ArduPilot Telemetry
  #include "telemetry/ardupilot.h"
#elif defined(NMEA)      // NMEA Telemetry
  #include "telemetry/nmea.h"
#elif defined(MAVLINK)   // Mavlink Telemetry
...
#if !defined(SIMU)
extern uint16_t s_anaFilt[NUMBER_ANALOG_ADC1];
#endif

#if defined(JITTER_MEASURE)
extern JitterMeter<uint16_t> rawJitter[NUMBER_ANALOG_ADC1];
extern JitterMeter<uint16_t> avgJitter[NUMBER_ANALOG_ADC1];
